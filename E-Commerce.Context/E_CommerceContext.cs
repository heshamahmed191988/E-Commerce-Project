...
namespace E_Commerce.Context
{
    public class E_CommerceContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Data Source=DESKTOP-RCPAOOJ\\ITI;Initial Catalog=E_Commerce_Last_Data;Integrated Security=True;Encrypt=False");//.UseLazyLoadingProxies();
